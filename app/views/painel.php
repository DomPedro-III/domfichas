        ...
        <div class="container">
            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary" onclick="window.location.href = '/domfichas/ficha?c=base&a=ver&id=<?php echo $items['id']; ?>'">Visualizar</button>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    ...
                    <button class="btn btn-success"  onclick="window.location.href = '/domfichas/ficha?c=base&a=ficha'">Cadastrar</button>
                </div>
            </div>
        </div>
